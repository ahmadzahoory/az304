...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ahmadzahoory/az304/master/lab-304-03-code-srv2.zip", (Get-Location).Path + "\lab-304-03-code-srv2.zip")

$zipfile = $shell_app.Namespace((Get-Location).Path + "\lab-304-03-code-srv2.zip")
